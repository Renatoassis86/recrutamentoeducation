            ...
            <main className="flex-grow pt-32 pb-24">
                <article className="mx-auto max-w-4xl px-6 lg:px-8">
                    ...
                    <div className="prose prose-lg prose-slate text-gray-700 leading-relaxed font-light text-justify max-w-none">
                        ...
                        <p>
                            Este documento estabelece as diretrizes fundamentais para a participação no processo de seleção de autores e revisores técnicos. O objetivo é selecionar educadores licenciados e pedagogos capazes de desenvolver materiais didáticos inovadores, alinhados aos princípios de uma educação cristã clássica, bilíngue e integral.
                        </p>
                        ...
                        <ul className="list-disc pl-6 space-y-2 my-6 marker:text-amber-500">
                            <li><strong>Perfis Profissionais:</strong> Detalhamento das áreas de conhecimento requeridas (Língua Portuguesa, Matemática, História, Geografia, Ciências, Arte e Pedagogia - Anos Iniciais).</li>
                            ...
                            <li><strong>Critérios de Seleção:</strong> Parâmetros utilizados pela banca examinadora para avaliar a competência técnica, pedagógica e teológica dos candidatos.</li>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8 mt-12 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="flex-1">
                            ...
                            <p className="text-gray-600 text-sm">
                                Leia atentamente o edital completo antes de realizar sua inscrição.
                            </p>
                        </div>
