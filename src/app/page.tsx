...
import { ArrowRight, BookOpen, PenTool, Video, Phone, Download, FileText, CheckCircle2, Instagram, Globe, GraduationCap, Laptop, BookUser, Clock, MapPin, Palette, Music, Microscope, Code2, Anchor, Lightbulb, Library } from "lucide-react";
...
export default function Home() {
  return (
    <div className="bg-white min-h-screen font-sans text-slate-900 selection:bg-amber-100 selection:text-amber-900">
      ...
      {/* 3.3 BOOK COVERS SHOWCASE (REORDERED & LANDSCAPE) */}
      ...
      {/* 4. OIKOS SPOTLIGHT SECTION (STORIES FORMAT) */}
      <section id="oikos" className="py-24 bg-slate-900 text-white overflow-hidden relative">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">

            {/* Visual Side (STORIES FORMAT 9:16) */}
      ...
      {/* 7. CONTATO & FOOTER (SPACING FIX) */}
      <footer id="contato" className="bg-slate-950 text-white pt-24 pb-12 border-t border-slate-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-16">

            {/* Identidade */}
            <div className="space-y-6">
              <h3 className="text-3xl font-bold font-serif text-amber-500">Cidade Viva Education</h3>
              ...
              <div className="flex gap-6 pt-4">
                <a href="https://instagram.com/cidadeviva.education" target="_blank" className="p-3 bg-slate-900 rounded-full hover:bg-amber-600 transition-colors group border border-slate-800 hover:border-amber-600">
                  <Instagram className="h-5 w-5 text-gray-400 group-hover:text-white" />
                </a>
                <a href="https://cidadeviva.education/" target="_blank" className="p-3 bg-slate-900 rounded-full hover:bg-blue-600 transition-colors group border border-slate-800 hover:border-blue-600">
                  <Globe className="h-5 w-5 text-gray-400 group-hover:text-white" />
                </a>
                <a href="https://wa.me/5583986048784" target="_blank" className="p-3 bg-slate-900 rounded-full hover:bg-green-600 transition-colors group border border-slate-800 hover:border-green-600">
            ...
            {/* Localização */}
            <div className="space-y-8 text-base text-gray-400">
              <div className="flex items-start gap-4">
                <MapPin className="h-6 w-6 text-amber-600 flex-shrink-0 mt-1" />
                <div>
                  <p className="font-bold text-white mb-2 tracking-wide uppercase text-xs text-amber-500">Unidade João Pessoa</p>
                  <p className="leading-relaxed">R. Lourdes Férrer, 191 - Aeroclube<br />João Pessoa - PB, 58036-630</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <Clock className="h-6 w-6 text-amber-600 flex-shrink-0 mt-1" />
                <div>
                  <p className="font-bold text-white mb-2 tracking-wide uppercase text-xs text-amber-500">Expediente</p>
                  <p className="leading-relaxed">Segunda a sexta-feira, das 9h às 18h<br />(Exceto feriados)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-600">
            <p>&copy; {new Date().getFullYear()} Cidade Viva Education. Todos os direitos reservados.</p>
            <a href="https://cidadeviva.org/" target="_blank" className="hover:text-amber-500 transition-colors">
